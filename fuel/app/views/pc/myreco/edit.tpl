<div>
	...
	<form class="pure-form pure-form-aligned edit_form" role="form" action="/myreco/add" method="POST">
		<fieldset>
			...
			<div class="pure-control-group" style="margin-top:20px;">
				<label>タグ</label>
				<input class="pure-input-2-3" type="text" name="tag" value="{$form_input['tag']|default:""}" placeholder="タグは,(カンマ)で区切って下さい">
			</div>

			<div class="pure-control-group" style="margin-top:20px;">
				<label>ムービー</label>
				<input class="pure-input-2-3" type="text" name="movie_url" value="{$form_input['movie_url']|default:""}" placeholder="YoutubeのURLを入力してください">
			</div>

			<div class="pure-control-group" style="margin-top:20px;">
				<label>コメント</label>
				<textarea class="pure-input-2-3" rows="6" name="comment" placeholder="この作品のおすすめポイント">{$form_input['comment']|default:""}</textarea>
			</div> 
			<div align="right">

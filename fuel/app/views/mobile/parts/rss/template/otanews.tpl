	...
	<div class="pure-g contents_list">
		<div class="pure-u-3-4 pure-u-md-19-24">
			<div style="padding:5px;">
				<h5 style="margin-top:0px;margin-bottom:0px;">{$rss['title']|mb_strimwidth:0:70:"…"|default:"設定してね"}</h5> <!-- 記事のタイトル -->
				<!-- コメントをここに表示 -->
				<p class="rss-label"><span class="label rss_anime">オタニュース</span></p>
			</div>
		</div>

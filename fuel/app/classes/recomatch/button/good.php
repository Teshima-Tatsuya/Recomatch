...
class Recomatch_Button_Good extends Recomatch_Button_Button {
	...
	public function createUnpushedButton($contents) {
		...
		$str .= '	<button class="pure-button '.$kind.'_button" href="#" style="margin-right:5px;">'.Asset::img('icon/'.$kind.'.png', ['width' => 24, 'class' => 'icon']).'<span class="button-string">好き</span></button>';
	...
	public function isPushed($contents, $user_id) {
		if (Model_Good::isPushed($contents, $user_id)) {
			return true;
		} else {
			return false;
		}

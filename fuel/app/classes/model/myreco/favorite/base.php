...
class Model_Question_Favorite_Base extends \Orm\Model {
	...
	public static function isFavorite($search_id, $user_id) {
		$last_name = static::getCalledClassLastName();
		$id_clm_name = $last_name . '_id';

		$favorite = static::find('first', array(
			'where' => array(
	...
	public static function isPushed($search_id, $user_id) {
		return self::isFavorite($search_id, $user_id);
	}
